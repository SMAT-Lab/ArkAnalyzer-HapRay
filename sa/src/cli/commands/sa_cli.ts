...
import { HapStaticAnalyzer } from '../../insight/hap-static-analyzer';
import type { FormatOptions } from '../../insight/formatters';
import { FormatterFactory, OutputFormat } from '../../insight/formatters';
...
// CLI命令定义
export const SaCli = new Command()
    .name('sa')
    .version(VERSION)
...
async function generateReport(
    result: import('../../insight/types').HapStaticAnalysisResult,
    format: OutputFormat,
    baseName: string,
    timestamp: string,
    output: string,

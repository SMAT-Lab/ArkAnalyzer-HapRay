...
class PerfLoad_ArkTsExample_0010(PerfTestCase):
    ...
    def process(self):
        ...
        self.execute_performance_step(
            'ArkTsExample-1500View测试场景-step1 ComposeView1500', 30, step1, sample_all_processes=True
        )
        self.driver.swipe_to_back()
        self.execute_performance_step(
            'ArkTsExample-1500View测试场景-step2 ComposeLazyView1500Page', 30, step2, sample_all_processes=True
        )
        self.driver.swipe_to_back()

...
class PerfLoad_bilibili_0010(PerfTestCase):
    ...
    def process(self):
        ...
        self.execute_performance_step('哔哩哔哩-首页浏览场景-step1哔哩哔哩启动', 10, step1)
        self.execute_performance_step('哔哩哔哩-首页浏览场景-step2首页滑动', 60, step2)
        ...
        self.execute_performance_step('哔哩哔哩-首页浏览场景-step3页面点击', 30, step3)

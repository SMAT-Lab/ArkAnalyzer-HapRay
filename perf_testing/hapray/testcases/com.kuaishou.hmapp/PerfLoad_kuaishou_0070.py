...
class PerfLoad_kuaishou_0070(PerfTestCase):
    ...
    def process(self):
        ...
        self.touch_by_text('开启视频直播', 2)

        def step1():
            time.sleep(30)

        self.execute_performance_step('快手-直播间-step1进入直播间，开始直播', 35, step1)

        # 右上角退出直播
        self.driver.touch(self.convert_coordinate(1012, 211))
        self.touch_by_text('我要关闭', 2)

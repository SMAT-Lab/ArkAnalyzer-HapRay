...
class ResourceUsage_PerformanceDynamic_zhifubao_0050(PerfTestCase):
    ...
    def process(self):
        ...
        def step1():
            ...
            time.sleep(2)
            for i in range(3):
                self._swipe(625, 2500, 625, 2100, 300)
                time.sleep(2)
            for i in range(3):
                self._swipe(625, 2100, 625, 2500, 300)
                time.sleep(2)
            time.sleep(3)
        ...
        def step2():
            ...
            time.sleep(2)
            self._swipe(625, 2500, 625, 1550, 300)
            time.sleep(2)
            self._swipe(625, 1550, 625, 2500, 300)
            time.sleep(2)

        def step3():
            # 芭芭农场，领肥料，上下拖滑3次，间隔2s
            # 点左边树苗

...
class PerfTestCase(TestCase, UIEventWrapper, ABC):
    ...
    def __init__(self, tag: str, configs):
        ...
        self.xvm = XVM(self)
        self.capture_ui_handler = CaptureUI(self.driver)
    ...
    def execute_performance_step(
        ...
        self.capture_ui_handler.capture_ui(step_id, self.report_path, 'start')
        ...
        try:
            ...
            self.capture_ui_handler.capture_ui(step_id, self.report_path, 'end')
        finally:

...
class UpdateAction:
    ...
    def execute(args):
        ...
        parser.add_argument('--symbolstatistic', type=str, default=None, help='Path to SymbolsStatistic.txt for symbol analysis')
        ...
        if parsed_args.mode == Mode.SIMPLE and parsed_args.symbolstatistic:
            ...
            from hapray.analyze.base_analyzer import AnalyzerHelper

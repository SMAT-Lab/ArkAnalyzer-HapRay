...
def create_simple_mode_structure(report_dir, perf_paths, trace_paths, package_name, **kwargs):
    ...
    Args:
        ...
        **kwargs: 可选参数
            ...
            memory_paths: memory文件路径列表（已废弃，保留用于向后兼容）
    """
    ...
    # 如果提供了 memory_paths，记录警告信息
    if memory_paths:
        logging.warning('memory_paths parameter is deprecated. Memory data will be extracted from trace.htrace files.')

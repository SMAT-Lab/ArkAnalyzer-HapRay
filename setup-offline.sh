...
pip install ${PIP_ARGS} xdevice-devicetest-5.0.7.200.tar.gz
pip install ${PIP_ARGS} xdevice-ohos-5.0.7.200.tar.gz
pip install ${PIP_ARGS} hypium-5.0.7.200.tar.gz

        ...
        try:
            ...
            for inst in instructions:
                ...
                # 2. 处理 add 指令：add x0, x0, #0x567
                    ...
                    if (
                        full_addr is not None
                        and section_vaddr <= full_addr < section_vaddr + section_size
                    ):
                ...
                # 3. 处理 adr 指令：adr x0, #0x1234
                    ...
                    if (
                        ...
                        and section_vaddr <= target_addr < section_vaddr + section_size
                    ):
    ...
    def _parse_ldr_immediate(self, op_str: str, section_vaddr: int, section_size: int) -> Optional[int]:
        ...
        try:
            ...
            if match:
                ...
                if (
                    imm_value > 0x1000
                    and section_vaddr <= imm_value < section_vaddr + section_size
                ):
                    return imm_value
        except (ValueError, IndexError):
            pass

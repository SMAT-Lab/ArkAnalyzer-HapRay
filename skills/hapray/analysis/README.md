...
| `symbol-recovery` | [`symbol-recovery-analysis.md`](symbol-recovery-analysis.md) | 同上；**新 clone 未构建**时先读 **`../SKILL.md` 源码硬门禁**与本文件 **§〇**，否则 Step1/perf→db 会先挂 | **SymRecover**（`tools/symbol_recovery`）、Radare2/r2dec、LLM 辅助；在线/离线/`--no-llm` |
